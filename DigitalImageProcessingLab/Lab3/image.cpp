...
QVector<QVector<unsigned short>> Image::getPixel(){return pixel;}
unsigned short Image::getAPixel(int x, int y){return this->pixel[x][y];}
...
void Image::setPixel(QVector<QVector<unsigned short>> pixel){this->pixel=pixel;}
void Image::setAPixel(int x, int y, unsigned short grayScale){this->pixel[x][y]=grayScale;}
